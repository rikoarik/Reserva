...
import com.reserva.employe.adapter.AdapterSaleOut;
...
public class SaleOut extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView mRecyclerView = (RecyclerView) findViewById(R.id.rcSaleOut);
        ...
        AdapterSaleOut mAdapter = new AdapterSaleOut(this, viewItems);
    ...
    private void addItemsFromJSON() {
        try {
            ...
            for (int i = 0; i < jsonArray.length(); ++i) {
                ...
                SaleOutModel stok = new SaleOutModel(produk, jumlah, image, tgl);
                viewItems.add(stok);
            }
    ...
    private String readJSONDataFromFile() throws IOException{
        ...
        try {
            ...
            inputStream = getResources().openRawResource(R.raw.saleout);
