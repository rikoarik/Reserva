...
import com.reserva.users.model.BONModel;
...
public class HairCareFragment extends Fragment {
    int tvharga1= 150000, tvharga2=200000, tvharga3=450000, tvharga4=800000;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tvHarga1 = view.findViewById(R.id.hargahc1);
        tvHarga2 = view.findViewById(R.id.hargahc2);
        tvHarga3 = view.findViewById(R.id.hargahc3);
        tvHarga4 = view.findViewById(R.id.hargahc4);
        tvChecbox1 = view.findViewById(R.id.checkboxhc1);
        tvChecbox2 = view.findViewById(R.id.checkboxhc2);
        tvChecbox3 = view.findViewById(R.id.checkboxhc3);
        tvChecbox4 = view.findViewById(R.id.checkboxhc4);

        tvnext = view.findViewById(R.id.btNexthc);
        tvDateTime = view.findViewById(R.id.dateTimehc);
